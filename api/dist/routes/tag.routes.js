...
router.post('/', auth_middleware_1.protect, (0, authorize_middleware_1.authorize)(client_1.Role.ADMIN), tagController.createTag);
router.delete('/:id', auth_middleware_1.protect, (0, authorize_middleware_1.authorize)(client_1.Role.ADMIN), tagController.deleteTag);
